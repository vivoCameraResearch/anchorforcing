...
(function attachGlobalOverlays() {
    ...
    items.forEach(item => {
        ...
        // Prefer reusing existing resolution badge if present (e.g., #long, #ultra-long)
        let badge = item.querySelector('.resolution, .resolution-svd, .resolution-sd3, .resolution-1-5');
        if (!badge) {
